...
function VendorCreatePro()
{
  let navigate=useNavigate()
    ...
    useEffect(()=>{
      fetch(`https://event-proposal-c3fx.onrender.com/fetchingEventData/${token_id}`)
    ...
    function img(e)
    {
      ...
      // venueData.image.push(e.target.files[0])
        ...
        data.append('upload_preset','event_proposal')
    ...
    function submit()
    {
        ...
        {
          console.log(location.state._id);
          fetch(`https://event-proposal-c3fx.onrender.com/updateData/${location.state._id}`,{
            method:'PATCH',
            headers:{
        ...
        {
          fetch(`https://event-proposal-c3fx.onrender.com/cresteEvent/${token_id}/${vendor_name}/${vendor_email}`,{
            method:'POST',
            headers:{
              'content-type':'application/json'
            },
